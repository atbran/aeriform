...
bool PatchStateManager::administrative(P p) noexcept {
    ...
    return isRackCommand(id)||p==P::sfCapture||p==P::sfRelease||p==P::roomClear||p==P::symClear||p==P::symCapture||starts(id,"morph_")||starts(id,"random_")||starts(id,"out_")||starts(id,"voice_")||starts(id,"mpe_")||std::strcmp(id,"quality")==0||p==P::bendRange;
}
