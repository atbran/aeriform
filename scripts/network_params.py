def register(F,C,B,I):
 ...
 F('contactGap','contact_gap','Contact Gap','Network',0,1,.05,'','Plain','Audible stop gap uses a squared response for finer control of quiet signals; physical force retains its conservative threshold.',centre=.1)
 ...
 F('contactDamping','contact_damping','Contact Damping','Network',0,1,.2,'%','Percent','Softens the reflected pickup response toward a muted, lossy stop.')
 ...
 F('contactAmount','contact_amount','Collision Amount','Network',0,1,.3,'%','Percent','Smoothed audible stop strength and loss-normalized physical coupling.')
